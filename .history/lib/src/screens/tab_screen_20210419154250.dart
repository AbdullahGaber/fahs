      ...
      child: Container(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            bottom: (_index == 1 && prefs.get('type') != 'مزود خدمة')
                ? PreferredSize(
                    preferredSize:
                        Size(double.infinity, mediaQuery.height * 0.09),
                    child: SearchWidget(
                      onSubmitted: (v) {
                        Navigator.of(context).push(
                          MaterialPageRoute(
          ...
          bottomNavigationBar: SizedBox(
            ...
            child: BottomNavigationBar(
              ...
              backgroundColor: Color(0xff272D45),
              selectedItemColor: Color(0xffA4BE25),
