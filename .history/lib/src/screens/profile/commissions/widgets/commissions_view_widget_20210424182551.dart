...
class CommissionsViewWidget extends StatelessWidget {
  final List<Datum> myCommissions;
                        ...
                        child: InkWell(
                          ...
                          child: CommissionsCard(
                            waitingForConfirmation:
                                myCommissions[i].paymentStatus == 0 &&
                                    myCommissions[i].paymentImage.isNotEmpty,
                            createdAt:
                                myCommissions[i].createdAt.substring(0, 10),
                            price: myCommissions[i].tax.toString(),
                            title:
