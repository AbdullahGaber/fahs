...
import 'package:t3myrkm/src/logic/models/provider/order/commissions_model.dart';
import 'package:t3myrkm/src/logic/providers/provider/order/commissions_provider.dart';
import 'package:t3myrkm/src/widgets/app_loader.dart';
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            bottom: PreferredSize(
              preferredSize: Size(mediaQuery.width, mediaQuery.height * 0.15),
              child: Consumer<CommissionsProvider>(
                builder: (_, snap, __) => snap.myCommissions.isEmpty
                    ? Container()
                    : TabBar(
