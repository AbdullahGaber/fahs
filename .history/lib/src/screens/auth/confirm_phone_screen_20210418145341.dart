          ...
          child: Form(
            child: Column(
              children: [
                ...
                Visibility(
                  visible: (widget.stateOfVerificationCode==1&&register.phone!=null)||(widget.stateOfVerificationCode==1&&confirmRessetCode.phone!=null)||(widget.stateOfVerificationCode==3&&changePhone.phone!=null),
                                  child: Center(
                      child: Text(
