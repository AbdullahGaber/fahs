                  ...
                  child: TextFieldWidget(
                    ...
                    onChanged: (value) {
                      ...
                      if (widget.title != 'إستعادة كلمة المرور') {
                        register.phone = codevalue;
                        number.phone = codevalue;
                        phoneNumber = codevalue;
                        verficate.phone = codevalue;
                      } else {
                        confirm.phone = codevalue;
                        forget.phone = codevalue;
                        reset.phone = codevalue;
                      }
                    },
