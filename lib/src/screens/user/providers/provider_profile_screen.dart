...
class ProviderProfileScreen extends StatefulWidget {
  ...
  ProviderProfileScreen({this.isFavorite = false});
  @override
              ...
              onPressed: () {
                CustomDialog().showOptionDialog(
                  ...
                  okFun: () {
                    ...
                    if (isFavorite) {
                      Fluttertoast.showToast(msg: 'تم الإضافة للمفضلة');
                    } else {
                      Fluttertoast.showToast(msg: 'تم الحذف من المفضلة');
                    }
                  },
                );
              },
          ...
          children: [
            ...
            Padding(
              ...
              child: Align(
                alignment: Alignment.centerRight,
                child: Text(
                  'محتوى تجريبي يتم استبداله فيما بعد بمحتوى معلومات عن المركز الحقيقية محتوى تجريبي يتم استبداله فيما بعد بمحتوى معلومات عن المركز الحقيقية محتوى تجريبي يتم استبداله فيما بعد بمحتوى معلومات عن المركز الحقيقية',
                  style: TextStyle(),
                ),
              ),
            ),
